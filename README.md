...
# Web page build RGB code - صفحه وب ساخت کد ار جی بی #

## **English** ##

This simple web page designed and make with **html**, **javascript**, **jquery** , **css**.

This site is written locally but is online with netlify
- [netlify](https://colorpi.netlify.app/)
...
این صفحه ساده وب طراحی شده با اچ تی ام ال و جاوااسکریپت و جی کوئری و سی اس اس طراحی شده است
این سایت به صورت لوکال نوشته شده اما با نتلیفای 
انلاین شده است
- [netlify](https://colorpi.netlify.app/)
